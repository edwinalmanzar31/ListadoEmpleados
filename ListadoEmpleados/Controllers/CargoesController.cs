...
namespace ListadoEmpleados.Controllers
{
    public class CargoesController : Controller
    {
        ...
        public CargoesController(ListadoEmpContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cargos != null ? 
                          ...
                          Problem("Entity set 'ListadoEmpContext.Cargos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'ListadoEmpContext.Cargos'  is null.");
            }
            var cargo = await _context.Cargos.FindAsync(id);
            if (cargo != null)
            {
